...
MIGRATION_MODULES = {"sites": "carda_link.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "carda_link.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = ['"Gouri Nandhan P V" <gourinandhanpv@gmail.com>']
